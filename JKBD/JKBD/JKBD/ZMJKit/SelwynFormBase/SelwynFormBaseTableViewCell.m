...
{
    if (!_horlelabel) {
        _horlelabel = [[UILabel alloc]init];
        _horlelabel.font = [UIFont systemFontOfSize:TitleFont];
        _horlelabel.adjustsFontSizeToFitWidth = YES;
        
        [self.contentView addSubview:_horlelabel];
    }
...
- (SelwynExpandableTextView *)textView
{
    if (!_textView) {
        ...
        _textView.font = [UIFont systemFontOfSize:TitleFont];
        //关闭textView滚动
